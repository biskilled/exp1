...
class MemoryFiles:
    ...
    def render_root_claude_md(self, ctx: dict) -> str:
        ...
        footer = [
            "---",
            "_Auto-generated by AgentDesk memory system. Run `/memory` to refresh._",
    ...
    def render_feature_claude_md(self, project: str, tag_name: str) -> str:
        ...
        lines += ["---", "_Auto-generated by AgentDesk. Run `/memory` to refresh._"]
        return "\n".join(lines)
    ...
    def render_openai_system(self, ctx: dict) -> str:
        ...
        lines += [
            f"_Generated by AgentDesk. Run /memory to refresh. Project: {project}_",
        ]
        return "\n".join(lines)
    ...
    def _render_code_md(self, ctx: dict) -> str:
        ...
        lines += ["---", "_Generated by AgentDesk. Run `/memory` to refresh._"]
        return "\n".join(lines)
