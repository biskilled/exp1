...
> Managed by aicli. Run `/memory` to refresh. Generated: 2026-03-08 03:04 UTC
...
- [2026-03-08] Lets start to fix that , as this is the major goal of this project - shared memory between diffrent llm, so I can use cl
- [2026-03-08] continue
