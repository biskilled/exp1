...
> Managed by aicli. Run `/memory` to refresh. Generated: 2026-04-29 20:14 UTC
...
- [2026-04-29] UI update - it is hard to see the Model as it is in white . can you do the same backround as you did in the Setting -> A
- [2026-04-29] looks better. I dont think I need the small white retore button that is placed on the left (under role name) as it is al
- [2026-04-29] Looks good. why only one is marked as BASED and all the rest ?
