...
> Generated by aicli 2026-04-28 20:44 UTC
...
- code_parser: tree-sitter (Python/JavaScript/TypeScript) with 180-day recency-weighted hotspot scoring EXP(-0.693 × age_ratio)
- deployment_backend: Railway (Dockerfile + railway.toml)
- deployment_desktop: Electron-builder (Mac dmg, Windows nsis, Linux AppImage+deb)
- mcp: Stdio MCP server with 14 tools; unified REST dispatch
- memory_prompts: YAML under backend/memory/prompts/ (react_base, pm, architect, developer, reviewer, project_synthesis)
- memory_files: Single source of truth: /memory POST endpoint writes project_state.json via Haiku synthesis; regenerates CLAUDE.md, CODE.md, PROJECT.md from JSON
