...
Last work (2026-03-08): It is lookls like hooks are not working now as I dont see new commits into the git repo (I am currently using the claude cli, so it is supposed to run