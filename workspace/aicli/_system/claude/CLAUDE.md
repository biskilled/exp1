...
- [2026-03-20] `claude_cli`: I still dont see the project loaded when app is started. all I can see in the logs is  Application s
- [2026-03-20] `claude_cli`: I am testing the Pipeline - when I clicked approved I do see the old md version . I would expcet to 
- [2026-03-20] `claude_cli`: I do see that last version is arhcitet, pm... and all the rest are not under old folder. Also - I wo
- [2026-03-20] `claude_cli`: Work Item pieplien suppose to use the existing roles - PM - project manage, architect - Sr architect
- [2026-03-20] `claude_cli`: I would like to start optimising the project motly the following buiding block - sql queries, and ru
