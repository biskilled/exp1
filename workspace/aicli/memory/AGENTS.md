...
# aicli
_2026-04-30 20:38 UTC | Memory synced: 2026-04-30_
...
- **role_config**: YAML factory defaults (workspace/_templates/pipelines/roles/*.yaml) seeded ON CONFLICT DO NOTHING
- **system_prompts**: 3 shared canonical presets in workspace/_templates/pipelines/system_prompts.yaml
...
- CLI chat history visibility: backend SQL reads src column for message sourcing; CLI chat sessions grouped by session in History view with prompts/responses properly displayed
...
- `backend/core/db_migrations.py` — score 18.0 (16 commits, 3442 lines)
- `ui/frontend/views/work_items.js` — score 12.0 (10 commits, 2830 lines)
