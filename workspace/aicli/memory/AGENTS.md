...
# aicli
_2026-05-03 21:59 UTC | Memory synced: 2026-05-03_
...
- **pipeline_config**: YAML files (workspace/_templates/pipelines/)
...
- `backend/core/db_migrations.py` — score 24.0 (22 commits, 4022 lines)
- `backend/routers/route_agents.py` — score 22.0 (20 commits, 1755 lines)
- `ui/frontend/views/work_items.js` — score 22.0 (20 commits, 3595 lines)
