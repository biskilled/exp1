...
# aicli
_2026-04-29 16:00 UTC | Memory synced: 2026-04-29_
...
- **prompt_storage**: YAML backend/memory/yaml_config/ and backend/agents/yaml_config/
...
- Pipeline YAML structure: pl_*.yaml files in workspace/_templates/pipelines/ reference roles only (no embedded task_prompt); pipeline stages execute role-based agents; user-specific customizations in workspace/aicli/pipelines/
