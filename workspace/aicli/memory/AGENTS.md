...
# aicli
_2026-04-29 17:13 UTC | Memory synced: 2026-04-29_
...
- Unified prompt storage: backend/memory/yaml_config/ stores memory command prompts; backend/agents/yaml_config/ stores agent/pipeline prompts
