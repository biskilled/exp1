...
- Audit unused columns in mem_ai_events table and remove deprecated fields from database schema
...
- Role YAML consolidation: all 10 roles stored in workspace/_templates/pipelines/roles/role_*.yaml with system_prompt, model, provider, temperature, max_tokens, max_iterations; no inline Python definitions
