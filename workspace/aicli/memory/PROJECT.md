...
- Pipeline YAML organization: workspace/_templates/pipelines/ contains role_*.yaml (10 files) and pl_*.yaml (8 pipeline files); workspace/aicli/pipelines/roles/ mirrors templates; backend/memory/yaml_config/ and backend/agents/yaml_config/ organized by concern
