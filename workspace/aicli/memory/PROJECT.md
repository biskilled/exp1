...
- Remove lifecycle tags from Planner UI and fix remaining 11 active UI bugs (drag-and-drop, category display, archive toggles, tagging UI errors, [object object] tag display)
