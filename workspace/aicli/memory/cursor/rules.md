...
> Managed by aicli. Run `/memory` to refresh. Generated: 2026-04-29 23:41 UTC
...
- [2026-04-29] There was a wroekd on roles - currently each role is defined as an agent where he can have promots, tools and mcp.  Role
- [2026-04-29] yes please. can you update that in the role and add those paramter into pipeline as well. I will work on pipeline design
- [2026-04-29] I do like in the setting the Agent Role - what I would like is to change the name to role & Pipeleine . show all roles a
- [2026-04-29] Just to confirm - the edit button in the setting/workflow - is it for editing the yaml file ? is it save as a new versio
- [2026-04-29] I would like to start to work on pipelines section.   pipeline and roles can be executed from thus tab (only approved pi