...
| `backend/core/db_migrations.py` | 24.0 | 22 | 4022 | 0 | 2026-05-03 |
| `backend/routers/route_agents.py` | 22.0 | 20 | 1755 | 0 | 2026-05-03 |
| `ui/frontend/views/work_items.js` | 22.0 | 20 | 3595 | 0 | 2026-05-03 |
...
| `backend/agents/agent.py` | 10.0 | 8 | 813 | 0 | 2026-05-03 |
...
|--------|--------|------------|
| `backend/routers/route_agents.py` | `ui/frontend/views/work_items.js` | 10 |
| `backend/memory/memory_work_items.py` | `ui/frontend/views/work_items.js` | 9 |
| `backend/core/db_migrations.py` | `backend/routers/route_agents.py` | 9 |
| `backend/core/db_migrations.py` | `ui/frontend/views/work_items.js` | 8 |
