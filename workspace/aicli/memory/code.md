<!-- Last updated: 2026-05-03 20:47 UTC -->
# Code Map: aicli
...
| `backend/core/db_migrations.py` | 23.0 | 21 | 3902 | 0 | 2026-05-02 |
| `backend/routers/route_agents.py` | 21.0 | 19 | 1480 | 0 | 2026-05-03 |
| `ui/frontend/views/work_items.js` | 21.0 | 19 | 3354 | 0 | 2026-05-02 |
...
| `backend/agents/agent.py` | 7.0 | 7 | 783 | 0 | 2026-05-03 |
...
| `backend/routers/route_agents.py` | `ui/frontend/views/work_items.js` | 9 |
| `backend/core/db_migrations.py` | `backend/routers/route_agents.py` | 8 |
