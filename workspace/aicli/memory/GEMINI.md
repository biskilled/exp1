<!-- Last updated: 2026-04-29 20:11 UTC -->
# aicli
_2026-04-29 20:11 UTC | Memory synced: 2026-04-29_
...
- **workflow_engine**: Async DAG executor (asyncio.gather) + YAML pipeline + per-pipeline retry
...
- `backend/core/db_migrations.py` — score 14.0 (12 commits, 3320 lines)
- `ui/frontend/views/prompts.js` — score 11.0 (9 commits, 1623 lines)
...
- `backend/routers/route_agent_roles.py` — score 8.0 (6 commits, 1343 lines)
...
_Last updated: 2026-04-29 20:11 UTC_