...
# aicli
_2026-05-02 21:41 UTC | Memory synced: 2026-05-02_
...
- Work item classification and embedding: AI draft rows cleaned up; approved items (UC/FE/BU/TA prefix) embedded to pgvector (1536-dim, text-embedding-3-small); semantic search via cosine similarity over mem_work_items
...
- `ui/frontend/views/work_items.js` — score 18.0 (16 commits, 3098 lines)
- `backend/routers/route_agents.py` — score 15.0 (13 commits, 1294 lines)
