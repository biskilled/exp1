...
# aicli
_2026-04-28 11:47 UTC | Memory synced: 2026-04-28_
...
- Role YAML: all agent roles + pipelines defined in workspace/_templates/ (no inline Python); work_item classification, pipeline execution, and prompt injection all template-driven.
