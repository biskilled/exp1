<!-- Last updated: 2026-04-26 22:38 UTC -->
...
- `backend/routers/route_projects.py` — score 10.0 (8 commits, 1676 lines)
- `backend/memory/memory_files.py` — score 9.0 (7 commits, 988 lines)
