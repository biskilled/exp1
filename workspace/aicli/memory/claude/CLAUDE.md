...
# aicli
_2026-04-28 20:19 UTC | Memory synced: 2026-04-28_
...
- **memory_prompts**: YAML files under backend/memory/prompts/
...
- Auto-deploy: post-Claude-session hook triggers auto_commit_push.sh for continuous delivery after every work session
