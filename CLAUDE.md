...
# aicli
_2026-04-30 00:32 UTC | Memory synced: 2026-04-30_
...
- **workflow_engine**: Async DAG executor (asyncio.gather) + YAML pipeline + per-node temperature/top_p/provider/model overrides
