...
- [2026-03-15] `claude_cli`: now that there is porper tagging - can you make sure all is linked, mapped propery in databse schema
- [2026-03-15] `claude_cli`: is it align to the 5 steps memory? is there is any addiotnal requirement in order to be able to retr
