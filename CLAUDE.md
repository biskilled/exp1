...
- [2026-03-28] `claude_cli`: I would like to understand more about the embedigng and chunk methods. I do understand it is happend
- [2026-03-28] `claude_cli`: I would embedding to be connected to the tagging. for example auth - will be meta data of all authen
