...
# aicli
_2026-04-27 23:50 UTC | Memory synced: 2026-04-27_
...
- **mcp**: Stdio MCP server with 10 tools
- **deployment_backend**: Railway (Dockerfile + railway.toml)
- **deployment_desktop**: Electron-builder (Mac dmg, Windows nsis, Linux AppImage+deb)
- **database_migrations**: PostgreSQL m001-m080+ with 4-agent pipeline columns
